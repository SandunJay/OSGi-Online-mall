...
import customerProducer.Customer;

public class ProducerMovieCustomer implements MovieCustomerProducer{
	...
	public String wellcome() {
		return "_________________________________ Wellcome to the Cinema !! _________________________________";
		
	}


	@Override
	public void insertProducerMovieCustomer(String name, String address, String email, String phone) {
